...
const roadmaps = {
  ...
  "frontend developer": {
    category: "software",
    steps: ["Learn HTML", "Learn CSS", "Learn JavaScript", "Learn React"]
  },
  "backend developer": {
    category: "software",
    steps: ["Learn Node.js", "Learn Databases", "Work with APIs"]
  },
  "data analyst": {
    category: "software",
    steps: ["Learn Excel", "Learn SQL", "Learn Python", "Data Visualization"]
  },
  "software engineer": {
    category: "software",
    steps: ["Learn Programming Languages", "Learn DSA", "System Design", "Build Projects"]
  },

  // HARDWARE (IoT) JOB ROLES
  "iot engineer": {
    category: "hardware",
    steps: ["Learn Embedded C", "Work with Arduino", "IoT Protocols", "Cloud Platforms"]
  },
  "pcb designer": {
    category: "hardware",
    steps: ["Understand Circuits", "Learn PCB Tools", "Design Projects"]
  },
  "embedded systems developer": {
    category: "hardware",
    steps: ["Microcontrollers", "RTOS Basics", "Sensors & Actuators"]
  }
};
